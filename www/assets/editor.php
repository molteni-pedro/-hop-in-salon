...
<html lang="es">
	<head>
		...
		<title>Editor HTML de Dénuée</title>
	</head>
	<body>
<?php 
			...
			<?php 
				...
				{ // existe un aviso de error
					...
					<div class="alert alert-danger " role="alert">
						<i class="bi bi-x-square-fill"></i> Error d'accés
					</div>
					<?php
				}
				...
				{ // existe un aviso de cierre de sesión
					...
					<div class="alert alert-success " role="alert">
						<i class="bi bi-check-square-fill"></i>	Sessió tancada correctament
					</div>
					<?php
				}
			?>
					<p>
						<label for="inputEmail" class="visually-hidden">Adreça d'Email </label>
						<input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="Adreça d'Email" required autofocus>
						<label for="inputPassword" class="visually-hidden">Contrasenya</label>
						<input type="password" id="inputPassword" name="inputPassword" class="form-control" placeholder="Contrasenya" required>
					</p>
					<p class="checkbox mb-3">
						<label>
							<input type="checkbox" id="inputRemember" name="inputRemember" value="1"> Recorda'm
						</label>
					</p>
					<p>
						<button class="w-100 btn btn-lg btn-primary" type="submit"><i class="bi bi-box-arrow-in-right"></i> Accedir</button>
					</p>
...
?>	
		...
		<nav class="navbar navbar-expand-sm navbar-light bg-light">
			<div class="container-lg">
				<a class="navbar-brand" href="index.php" target="_blank">Dénuée Montibello</a>
				...
				<div class="collapse navbar-collapse " id="cabecera">
					<ul class="navbar-nav ms-auto">
						<li class="nav-item">
							<a class="nav-link- btn btn-outline-secondary btn-sm" href="editor.php?salir"><i class="bi bi-box-arrow-right"></i> Sortir</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<main class="container-lg">
			...
			<div class="alert alert-secondary" role="alert">
				Utilitza l'estil <code>Codi</code> perquè surti del <span style="color:#f0f;">color de ressalt</span>
			</div>
	<?php
	...
	{ // existen datos a actualizar
		...
		?>
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<i class="bi bi-x-square-fill"></i> Error de desat a:<br>
				<strong>
				<?php
		...
		?>
			<div class="alert alert-success alert-dismissible fade show" role="alert">
				<i class="bi bi-check-square-fill"></i> Dades guardades
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
			</div>	
		<?php		
		}
	...
	?>
		...
		?>
					<div class="tab-pane fade <?php echo ($id=='es')?'show active':'';?>" id="idioma-<?php echo $id;?>" role="tabpanel" aria-labelledby="<?php echo $id;?>">
						<label for="texto-<?php echo $id;?>" class="form-label">Contingut</label>
						...
						?></textarea>
						<div id="textoHelp-<?php echo $id;?>" class="form-text">Codi HTML.</div>
		...
		?>
				...
				<button type="submit" class="btn btn-primary mb-5"><i class="bi bi-save2-fill"></i> Desa</button>
			</form>
